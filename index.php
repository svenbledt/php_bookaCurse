        ...
        <div class="container">
          <div class="row m-3">
            ...
            <div class="col m-1 p-2 title-font-header contenthead">
              ...
              <p id="titlelead" style="text-align:left;">Stranger Tongues&#8482; - strange language-classes for special
          ...
          <div class="col-sm px-5" style="height:max-content;">
            ...
            <form action="confirmation.php" method="post">
              ...
              <div class="mb-4 input-group">
                ...
                <input type="text" class="form-control text-white bg-dark" name="valMail" id="valMailvalue"
                ...
                <div class="input-group-text" style="font-size: 80%"><label for="newsletter">Sub to Newsletter?</label>
                  <input class="form-check-input mt-0 mx-1" name="newsletter" id="newsletter" type="checkbox" value=""
